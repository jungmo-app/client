...
const SheetPortal = ({ children }: { children: React.ReactNode }) => {
  ...
  return container ? <SheetPrimitive.Portal container={container}>{children}</SheetPrimitive.Portal> : null;
};
...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Overlay
    ref={ref}
    className={cn(
      'absolute inset-0 z-[9999] bg-black/50 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0',
      className
    )}
    {...props}
  />
